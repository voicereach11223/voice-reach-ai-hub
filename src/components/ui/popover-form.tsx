  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex h-11 items-center border border-accent/20 bg-gradient-to-r from-accent to-primary px-6 text-sm font-semibold text-white shadow-[0_0_20px_rgba(var(--accent-rgb),0.3)] hover:shadow-[0_0_30px_rgba(var(--accent-rgb),0.5)] transition-all duration-300 outline-none"
      >
            ...
            <AnimatePresence mode="popLayout">
              {showSuccess ? (
                ...
                <motion.div
                  ...
                  className="h-full border border-border bg-background z-20"
                >
                  {openChild}
                </motion.div>
              )}
...
export function PopoverFormButton({
  ...
  return (
    <button
      type="submit"
      className="ml-auto flex h-9 w-28 items-center justify-center overflow-hidden rounded-md bg-gradient-to-r from-accent to-primary px-4 text-sm font-semibold text-white shadow-[0_0_15px_rgba(var(--accent-rgb),0.3)] hover:shadow-[0_0_25px_rgba(var(--accent-rgb),0.5)] transition-all duration-300"
    >
...
export function PopoverFormSuccess({
  ...
  return (
    <>
      ...
      <h3 className="mb-1 mt-2 text-sm font-semibold text-foreground">{title}</h3>
